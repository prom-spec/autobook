package com.openloud.ui.import_
...
import com.openloud.data.db.BookFormat
import com.openloud.data.db.ChapterEntity
import com.openloud.data.repository.BookRepository
import com.openloud.domain.chapter.ChapterDetector
import com.openloud.domain.chapter.ContentCleaner
import com.openloud.domain.cover.CoverArtFetcher
import com.openloud.domain.parser.DocxParser
import com.openloud.domain.parser.EpubParser
import com.openloud.domain.parser.Fb2Parser
import com.openloud.domain.parser.MobiParser
import com.openloud.domain.parser.OdtParser
import com.openloud.domain.parser.PdfParser
import com.openloud.domain.parser.TxtParser
            ...
            try {
                ...
                val meta = when (format) {
                    ...
                    BookFormat.MOBI, BookFormat.FB2, BookFormat.ODT, BookFormat.DOCX -> {
                        val parser: com.openloud.domain.parser.BookParser = when (format) {
